...
variable "openshift-public-ip" {
  default = "/subscriptions/9e54bcbd-ad57-485e-a4c4-5fb4e661fb9f/resourceGroups/cloud-shell-storage-westeurope/providers/Microsoft.Network/publicIPAddresses/dop-public-ip"
}
